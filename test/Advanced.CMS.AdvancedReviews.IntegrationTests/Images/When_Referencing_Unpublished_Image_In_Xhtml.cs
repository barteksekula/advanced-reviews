...
public class When_Referencing_Unpublished_Image_In_Xhtml(When_Referencing_Unpublished_Image_In_Xhtml.TestFixture fixture)
    : IClassFixture<CommonFixture>, IClassFixture<When_Referencing_Unpublished_Image_In_Xhtml.TestFixture>
{
    public class TestFixture(SiteFixture siteFixture) : IAsyncLifetime
    {
        ...
        public async Task InitializeAsync()
        {
            ...
            DraftPage = ContentRepository.CreatePage().ReferenceUnpublishedImageInXhtml(DraftImage.ContentLink)
                .PublishPage();
    ...
    public async Task It_Returns_200_And_Image_Is_Proxied()
    {
        ...
        //TODO: HTML DOES NOT LOAD DRAFT IMAGES
