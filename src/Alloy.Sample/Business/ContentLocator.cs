    ...
    IPageCriteriaQueryService pageCriteriaQueryService)
{
    ...
    private IEnumerable<PageData> FindPagesByPageTypeRecursively(ContentReference pageLink, int pageTypeId)
    {
    ...
    {
        var contactsRootPageLink = contentLoader.Get<StartPage>(siteUriResolver.GetStartPage()).ContactsPageLink;
